...
export const MEGA_MAP: Record<string, MegaEntry[]> = {
  ...
  Charizard:   [{ stone: "Charizardite X", megaSpecies: "Charizard-Mega-X" },
  ...
  Mewtwo:      [{ stone: "Mewtwonite X",   megaSpecies: "Mewtwo-Mega-X" },
  ...
  Absol:       [{ stone: "Absolite",       megaSpecies: "Absol-Mega" },
  ...
  Garchomp:    [{ stone: "Garchompite",    megaSpecies: "Garchomp-Mega" },
                { stone: "Garchompite Z",  megaSpecies: "Garchomp-Mega-Z" }],
  Lucario:     [{ stone: "Lucarionite",    megaSpecies: "Lucario-Mega" },
  ...
  "Floette-Eternal":[{ stone: "Floettite", megaSpecies: "Floette-Eternal-Mega" }],
  ...
  // Legends: Z-A DLC
  Raichu:      [{ stone: "Raichunite X",   megaSpecies: "Raichu-Mega-X" },
